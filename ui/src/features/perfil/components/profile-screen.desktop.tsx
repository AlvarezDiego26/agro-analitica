...
import { BadgeCheck, User, Bell, Award, CreditCard, Globe, HelpCircle, LogOut } from "lucide-react";
...
export function DesktopProfileScreen() {
  const settingsOptions = [
    {
      title: "Mi cuenta",
      subtitle: "Manuel Quispe · DNI 4***5821",
      icon: User,
      color: "text-blue-600",
      bg: "bg-blue-50"
    },
        ...
        <div className="w-[350px] shrink-0 flex flex-col gap-4">
          <UiCard className="p-8 flex flex-col items-center justify-center text-center shadow-sm border-gray-200 h-full relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <h2 className="text-[24px] font-black text-gray-900 leading-tight">Manuel Quispe</h2>
              <p className="text-[14px] font-medium text-gray-500 mt-1 mb-4">Fundo San Juan · Ica</p>
